jQuery(function($) {
  ...
  .find('.dataTables_filter').addClass('dt-buttons btn-group text-right w-auto mt-1 pr-3').prependTo('.table-tools-col').find('input').addClass('pl-45').removeClass('form-control-sm')
