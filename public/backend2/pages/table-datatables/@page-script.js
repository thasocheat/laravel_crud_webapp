jQuery(function($) {
    ...
    $('.table-tools-col')
        ...
        // and add a "+" button
        .end().append('<button data-rel="tooltip" data-toggle="modal" data-target="#openModal" type="button" class="btn radius-round btn-outline-primary border-2 btn-sm ml-2" title="Add New"><i class="fa fa-plus"></i></button>')
