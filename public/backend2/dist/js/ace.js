        ...
        _createClass(FileInput, [{
            ...
            value: function showFileList($files, innerCall) {
                ...
                var _loop = function _loop(i) {
                    ...
                    else if (_this4._hasFile && files[i] instanceof window.File) filename = files[i].name.trim();
    ...
    var Wysiwyg = /*#__PURE__*/ function() {
        ...
        _createClass(Wysiwyg, [{
            ...
            value: function initEditor() {
                ...
                else toolbar = $__default['default'](this._element).before(toolbarHtml).prev(); // otherwise put it just before our DIV
